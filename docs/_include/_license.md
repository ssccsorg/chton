...
- Official repository: [GitHub](https://github.com/ssccsorg). Authenticated via GPG: [BCCB196BADF50C99](https://keys.openpgp.org/search?q=BCCB196BADF50C99). Licensed under *Apache 2.0*; hardware sources (HDL, constraints, synthesis and PDK flow) under *CERN-OHL-P v2*..
